    ...
    <>
      ...
      >
        ...
        <ButtonGroup color={"secondary"} size="small">
          <Button onClick={() => setColor("primary")}>
            Primary
          </Button>
          <Button onClick={() => setColor("primary-alt")}>
            Primary Alt
          </Button>
          <Button onClick={() => setColor("error")}>
            Destructive
          </Button>
          <Button onClick={() => setColor("default")}>
            Neutral
          </Button>
          <Button onClick={() => setColor("secondary" )}>
            Secondary
          </Button>
          <Button onClick={() => setColor("minimal")}>
            Minimal
          </Button>
        </ButtonGroup>
        <code>Variant: {variant}</code>
        <ButtonGroup color={"secondary"} size="small">
          <Button onClick={() => setVariant("contained")}>
            Contained
          </Button>
          <Button onClick={() => setVariant("outlined")}>
            Outlined
          </Button>
          <Button onClick={() => setVariant("text")}>
            Text
          </Button>
        </ButtonGroup>
      </Box>
